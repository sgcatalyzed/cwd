//! All integration tests are commented out for now.
//!
//! This is because cw-multi-test has poor compatibility with cw-sdk.
//!
//! The plan is that there will be a testing package specifically for cw-sdk.
//! By then we will migrate these tests to that package.
